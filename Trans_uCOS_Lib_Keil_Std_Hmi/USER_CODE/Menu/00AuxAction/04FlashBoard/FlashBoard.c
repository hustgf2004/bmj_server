...
**
**--------------File Info---------------------------------------------------------------------------------
** File name:               FlashBoard.c
** Latest modified Date:    2021-09-22
** Latest Version:          1.0
** Descriptions:            辅助动作-伸/收插板
**
**--------------------------------------------------------------------------------------------------------
** Created by:              超人力霸王
...
/*********************************************************************************************************
  内部使用变量
*********************************************************************************************************/
static const  char *const __SscFlashBoardStr[] = {    
    "插板伸    插板收"};
...
static INT32S __menuItemCreate(MENU_ITEM_INFO *pmiiThis)
{
    ...
    pmiiThis->pvPara = (void *)&puiValveTbl[FLASHBOARD_OUT];
    return SYS_OK;
}
...
INT32S __menuItemParamFmt(MENU_ITEM_INFO *pmiiThis, void *pvRsv)
{
    ...
    sprintf(pvRsv, "%s", __SscFlashBoardStr[0]);

    return SYS_OK;
}

const MENU_ITEM_FUNC GmifFlashBoard = {
    __menuItemCreate,
    __menuItemDel,
    __menuItemOnKey,
    __menuItemParamFmt
...
/*********************************************************************************************************
  辅助动作插板菜单项定义
*********************************************************************************************************/
const MENU_ITEM_INFO_BASE __GmiibFlashBoard = {                         /*  菜单项信息                  */
    "",
    (MENU_ITEM_FUNC *)&GmifFlashBoard,
    0x0004,    
};
