...
/*********************************************************************************************************
  内部使用变量
*********************************************************************************************************/
static const  char *const __SscRsv1Str[] = {    
    "备用1A    备用1B"};
...
static INT32S __menuItemCreate(MENU_ITEM_INFO *pmiiThis)
{
    ...
    pmiiThis->pvPara = (void *)&puiValveTbl[RSV1];
    return SYS_OK;
}
...
INT32S __menuItemParamFmt(MENU_ITEM_INFO *pmiiThis, void *pvRsv)
{
    ...
    sprintf(pvRsv, "%s", __SscRsv1Str[0]);

    return SYS_OK;
}

const MENU_ITEM_FUNC GmifRsv1 = {
    __menuItemCreate,
    __menuItemDel,
    __menuItemOnKey,
    __menuItemParamFmt
...
/*********************************************************************************************************
  辅助动作备用菜单项定义
*********************************************************************************************************/
const MENU_ITEM_INFO_BASE __GmiibRsv1 = {                             /*  菜单项信息                  */
    "",
    (MENU_ITEM_FUNC *)&GmifRsv1,
    0x0006,    
};
