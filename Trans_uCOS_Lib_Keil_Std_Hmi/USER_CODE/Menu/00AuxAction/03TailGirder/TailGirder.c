...
**
**--------------File Info---------------------------------------------------------------------------------
** File name:               TailGirder.c
** Latest modified Date:    2021-09-22
** Latest Version:          1.0
** Descriptions:            辅助动作-伸/收尾梁
**
**--------------------------------------------------------------------------------------------------------
** Created by:              超人力霸王
...
/*********************************************************************************************************
  内部使用变量
*********************************************************************************************************/
static const  char *const __SscTailGirderStr[] = {    
    "尾梁伸    尾梁收"};
...
static INT32S __menuItemCreate(MENU_ITEM_INFO *pmiiThis)
{
    ...
    pmiiThis->pvPara = (void *)&puiValveTbl[TAIL_GIRDER_OUT];
    return SYS_OK;
}
...
INT32S __menuItemParamFmt(MENU_ITEM_INFO *pmiiThis, void *pvRsv)
{
    ...
    sprintf(pvRsv, "%s", __SscTailGirderStr[0]);

    return SYS_OK;
}

const MENU_ITEM_FUNC GmifTailGirder = {
    __menuItemCreate,
    __menuItemDel,
    __menuItemOnKey,
    __menuItemParamFmt
...
/*********************************************************************************************************
  辅助动作尾梁伸/收菜单项定义
*********************************************************************************************************/
const MENU_ITEM_INFO_BASE __GmiibTailGirder = {                         /*  菜单项信息                  */
    "",
    (MENU_ITEM_FUNC *)&GmifTailGirder,
    0x0002,    
};
