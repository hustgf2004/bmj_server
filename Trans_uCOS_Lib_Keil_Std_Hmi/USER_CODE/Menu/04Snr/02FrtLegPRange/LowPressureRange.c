...
**
**--------------File Info---------------------------------------------------------------------------------
** File name:               LowPressureRange.c
** Latest modified Date:    2017-04-03
** Latest Version:          1.0
** Descriptions:            低压力传感器量程菜单项
**
**--------------------------------------------------------------------------------------------------------
** Created by:              
...
/*********************************************************************************************************
  内部使用变量
*********************************************************************************************************/
const MENU_ITEM_FUNC GmifLowPressureRange = {
    __menuItemCreate,
    __menuItemDel,
    __menuItemOnKey,
    __menuItemParamFmt
...
static INT32S __menuItemCreate (MENU_ITEM_INFO *pmiiThis)
{
    ...
    *  ............
    */
    pmiiThis->pvPara = (FP32 *)&GdiDevInfo.fpPressureRange[0];
    return SYS_OK;
}
...
static INT32S __menuItemOnKey (MENU_ITEM_INFO *pmiiThis, INT16U usLen, void *pvData)
{
    ...
    */
    ...
    if ((INPUT_COMPLETED == ucErr) &&                                   /*  参数输入完成                */
        ((fpRtn > 0.0f) &&
        (fpRtn <= 99.9f))) {                                            /*  合理数值                    */
        GdiDevInfo.fpPressureRange[0] = fpRtn;
...
/*********************************************************************************************************
  低压传感器量程菜单项定义
*********************************************************************************************************/
const MENU_ITEM_INFO_BASE __GmiibLowPressureRange = {                   /*  菜单项信息                  */
    "低压量程",
    (MENU_ITEM_FUNC *)&GmifLowPressureRange,
    0x1402
};
