...
**
**--------------File Info---------------------------------------------------------------------------------
** File name:               ClosePDeltaThreshold.c
** Latest modified Date:    2017-04-20
** Latest Version:          1.0
** Descriptions:            TOP_OFF->close切换压差阈值菜单项
**
**--------------------------------------------------------------------------------------------------------
** Created by:              
...
/*********************************************************************************************************
  内部使用变量
*********************************************************************************************************/
const MENU_ITEM_FUNC GmifClosePDeltaThreshold = {
    __menuItemCreate,
    __menuItemDel,
    __menuItemOnKey,
    __menuItemParamFmt
...
static INT32S __menuItemCreate (MENU_ITEM_INFO *pmiiThis)
{
    ...
    *  ............
    */
    pmiiThis->pvPara = (FP32 *)&GdiDevInfo.fpDeltaPThreshold[3];
    return SYS_OK;
}
...
static INT32S __menuItemOnKey (MENU_ITEM_INFO *pmiiThis, INT16U usLen, void *pvData)
{
    ...
    */
    ...
    if ((INPUT_COMPLETED == ucErr) &&                                   /*  参数输入完成                */
        ((fpRtn > 0.0f) &&
        (fpRtn <= 99.9f))) {                                            /*  合理数值                    */
        GdiDevInfo.fpDeltaPThreshold[3] = fpRtn;
...
/*********************************************************************************************************
  TOP_OFF->close切换压差阈值菜单项定义
*********************************************************************************************************/
const MENU_ITEM_INFO_BASE __GmiibClosePDeltaThreshold = {               /*  菜单项信息                  */
    "截止阈值",
    (MENU_ITEM_FUNC *)&GmifClosePDeltaThreshold,
    0x1410
};
