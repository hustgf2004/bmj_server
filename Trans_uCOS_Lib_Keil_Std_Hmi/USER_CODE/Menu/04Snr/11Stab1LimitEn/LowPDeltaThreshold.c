...
**
**--------------File Info---------------------------------------------------------------------------------
** File name:               LowPDeltaThreshold.c
** Latest modified Date:    2017-04-20
** Latest Version:          1.0
** Descriptions:            低压->中压切换压差阈值菜单项
**
**--------------------------------------------------------------------------------------------------------
** Created by:              
...
/*********************************************************************************************************
  内部使用变量
*********************************************************************************************************/
const MENU_ITEM_FUNC GmifLowPDeltaThreshold = {
    __menuItemCreate,
    __menuItemDel,
    __menuItemOnKey,
    __menuItemParamFmt
...
static INT32S __menuItemCreate (MENU_ITEM_INFO *pmiiThis)
{
    ...
    *  ............
    */
    pmiiThis->pvPara = (FP32 *)&GdiDevInfo.fpDeltaPThreshold[0];
    return SYS_OK;
}
...
static INT32S __menuItemOnKey (MENU_ITEM_INFO *pmiiThis, INT16U usLen, void *pvData)
{
    ...
    */
    ...
    if ((INPUT_COMPLETED == ucErr) &&                                   /*  参数输入完成                */
        ((fpRtn > 0.0f) &&
        (fpRtn <= 99.9f))) {                                            /*  合理数值                    */
        GdiDevInfo.fpDeltaPThreshold[0] = fpRtn;
...
/*********************************************************************************************************
  低压->中压切换压差阈值菜单项定义
*********************************************************************************************************/
const MENU_ITEM_INFO_BASE __GmiibLowPDeltaThreshold = {                 /*  菜单项信息                  */
    "低压阈值",
    (MENU_ITEM_FUNC *)&GmifLowPDeltaThreshold,
    0x140D
};
