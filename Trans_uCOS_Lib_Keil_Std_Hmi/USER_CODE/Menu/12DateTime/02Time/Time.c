    ...
    */
    ...
    if (KEY_ENTER == puiKeyCode[0]) {
        ...
        if ((uiTemp[0] < 1)  ||
            ...
            GdsDevStatus.pdTime.hour     = uiTemp[0];
            GdsDevStatus.pdTime.minute   = uiTemp[1];//__SrtcTime.month;
            GdsDevStatus.pdTime.second   = uiTemp[2];
...
INT32S __menuItemParamFmt(MENU_ITEM_INFO *pmiiThis, void *pvRsv)
{
    ...
    */
    ...
    sprintf(pvRsv, ":%02d:%02d:%02d   ", prtcTime->hour,prtcTime->minute, prtcTime->second);
    return SYS_OK;
}
...
/*********************************************************************************************************
  时间菜单项定义
*********************************************************************************************************/
const MENU_ITEM_INFO_BASE __GmiibTime = {                               /*  菜单项信息                  */
    "时间",
    (MENU_ITEM_FUNC *)&GmifTime,
    0x0602
};
