...
/*********************************************************************************************************
  内部使用变量
*********************************************************************************************************/
const MENU_ITEM_FUNC GmifPusherOutActTime = {
    __menuItemCreate,
    __menuItemDel,
    __menuItemOnKey,
    __menuItemParamFmt
...
static INT32S __menuItemCreate (MENU_ITEM_INFO *pmiiThis)
{
    ...
    *  ............
    */
    pmiiThis->pvPara = (void *)&Gdp.ucPusherOutActT;
    return SYS_OK;
}
...
/*********************************************************************************************************
  伸推移动作时间菜单项定义
*********************************************************************************************************/
const MENU_ITEM_INFO_BASE __GmiibPusherOutActTime = {                   /*  菜单项信息                  */
    "推移伸动作",
    (MENU_ITEM_FUNC *)&GmifPusherOutActTime,
    0x0305,
