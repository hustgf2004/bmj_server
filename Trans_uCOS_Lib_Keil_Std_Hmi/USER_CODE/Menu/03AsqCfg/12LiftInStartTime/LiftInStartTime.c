...
/*********************************************************************************************************
  内部使用变量
*********************************************************************************************************/
const MENU_ITEM_FUNC GmifLiftInStartTime = {
    __menuItemCreate,
    __menuItemDel,
    __menuItemOnKey,
    __menuItemParamFmt
...
static INT32S __menuItemCreate (MENU_ITEM_INFO *pmiiThis)
{
    ...
    *  ............
    */
    pmiiThis->pvPara = (void *)&Gdp.ucLiftInStartT;
    return SYS_OK;
}
...
/*********************************************************************************************************
  抬架收开始时间菜单项定义
*********************************************************************************************************/
const MENU_ITEM_INFO_BASE __GmiibLiftInStartTime = {                  /*  菜单项信息                  */
    "抬架收开始",
    (MENU_ITEM_FUNC *)&GmifLiftInStartTime,
    0x030C,
