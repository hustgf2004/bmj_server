...
{  uint8  *str;
   ...
   back_color = LGRAY;
   GUI_RectangleFill(win->x, win->y, win->x + win->with - 1, win->y + 22, back_color);
   GUI_RectangleFill(win->x, win->y + win->hight - 11, win->x + win->with - 1, win->y + win->hight - 1, back_color);
